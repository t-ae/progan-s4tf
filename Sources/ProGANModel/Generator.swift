...
public struct Generator: Layer {
    ...
    public var toRGB1 = EqualizedConv2D(inputChannels: 1, outputChannels: 1, kernelSize: (1, 1), gain: 1) // dummy at first
    public var toRGB2 = EqualizedConv2D(inputChannels: 256, outputChannels: 3, kernelSize: (1, 1), gain: 1)
    ...
    public mutating func grow() {
        ...
        toRGB1 = toRGB2
        toRGB2 = EqualizedConv2D(inputChannels: io.1, outputChannels: 3, kernelSize: (1, 1), gain: 1)
    }
